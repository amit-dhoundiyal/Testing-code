ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Create Ethereum"
  ...
  #
  # Default:
  config.root_to = 'admin_users#dashboard'
  ...
  #
    config.namespace :admin do |admin|
      admin.build_menu :utility_navigation do |menu|
        menu.add label: "Create Ethereum", url: "/", html_options: { target: :blank }
      end
    end
  #
  ...
  #
   #config.filters = true  
     #config.namespace :admin do |admin|
      #admin.build_filter :deafult do |fil|
      #fil.add label: "Maximum Likes"
      #end
     # end
  #
